...
module.exports = function (app) {
    ...
    app.post(`/${endpoint_directory}/${endpoint_category}/disconnect_twitch`, async (request, response, next) => {
        try {  
            ...
            if (request.body.token) {
                ...
                if (!functions.empty(userExists)) {
                    ...
                    console.log(userExists.connected_accounts, "connected accounts")
                    ...
                    if (user) {
                        response.status(200).json({
                            "status": 200,
                            "message": "Successfully disconnected twitch account.",
                            "payload": payload
                        })
                    }
