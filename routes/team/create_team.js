...
module.exports = function (app) {
    ...
    app.post(`/${endpoint_category}/create_team`, async (request, response) => {
        ...
        */
        ...
        if (request.body.token && request.body.name && request.body.email && request.body.password) {
            ...
            let teamExists = await TEAM.find({ token: request.body.token, email: request.body.email})
